...
#dig +short tr.sfpl.io | grep -v "116.202.183.82" | awk '{system("echo nats-route://"$1":6222")}' | xargs | sed -e 's/ /,/g' | sed -E 's/nats-route:\/\/nats-seed1:6222/\0/pg' seed.conf > temp.conf
